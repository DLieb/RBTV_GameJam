...
public class CharacterSelection : MonoBehaviour
{
    ...
    public void changeAvatarSelection(PlayerEnum player, int iteration)
    {
        switch (player)
        {
            ...
            case PlayerEnum.Player2:
                if (!player2Locked)
                {
                    ...
                    textMeshes[1].text = player + "Has " + characterAvatars[p2Iterator].name +
                                         "selected";
                }
                break;
            case PlayerEnum.Player3:
                if (!player3Locked)
                {
                    ...
                    textMeshes[2].text = player + "Has " + characterAvatars[p3Iterator].name +
                                         "selected";
                }
                break;
            case PlayerEnum.Player4:
                if (!player4Locked)
                {
                    ...
                    textMeshes[3].text = player + "Has " + characterAvatars[p4Iterator].name +
                                         "selected";
                }
                break;
        }
